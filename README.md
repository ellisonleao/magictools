...
- :tada: [NobodyWho](https://github.com/nobodywho-ooo/nobodywho) - On-device LLM inference engine for embedding local, offline AI characters and dialogue in games, with no server or API key. Rust + llama.cpp, with streaming generation, embeddings, GBNF grammar-constrained output and Whisper speech-to-text.
